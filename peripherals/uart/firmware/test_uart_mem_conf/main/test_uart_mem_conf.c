/**
 * test_uart_mem_conf — ESP32-C3 uart peripheral test
 *
...
void app_main(void)
{
    printf("[UART] === test_uart_mem_conf ===\n");

    /* Read MEM_CONF_REG reset value */
    print_reg("UART_MEM_CONF_REG", UART_MEM_CONF_REG(0));
