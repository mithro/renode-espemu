/**
 * test_syscon_front_end — ESP32-C3 rng peripheral test
 *
...
void app_main(void)
{
    printf("[SYSCON] === test_syscon_front_end ===\n");

    print_reg("SYSCON_FRONT_END_MEM_PD_REG", SYSCON_FRONT_END_MEM_PD_REG);
