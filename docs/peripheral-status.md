...
| 5 | Timer Group | 0x6001F000 | 0x100 | 26 | 10 tests | 10 | Reviewed + fixed |
| 6 | SYSTEM (DPORT) | 0x600C0000 | 0x1000 | 40 | 8 tests | 8 | Reviewed + fixed |
| 7 | RNG / SYSCON | 0x60026000 | 0x1000 | 39 | 6 tests | 6 | Reviewed + fixed |
| 8 | GPIO | 0x60004000 | 0x1000 | 199 | 10 tests | 10 | Reviewed + fixed |
| 9 | ExtMem (Cache) | 0x600C4000 | 0x1000 | 66 | 10 tests | 10 | Reviewed + fixed |
| 10 | UART0 | 0x60000000 | 0x100 | 33 | 10 tests | 10 | Reviewed + fixed |
| 11 | IO MUX | 0x60009000 | 0x1000 | 23 | 3 tests | N/A | New |
| 12 | SPI MEM (Flash) | 0x60002000 | 0x1000 | ~30 | N/A | N/A | New, init_flash WIP |
...
| 27 | World Controller | 0x600D0000 | Security |
...
```
python3 tools/ci.py                           # Build + Renode tests
python3 tools/ci.py --hardware                # Also flash to rpi4-esp
python3 tools/build_all_firmware.py           # Build all 120 firmware
python3 tools/run_renode_tests.py             # Run 12 Robot tests
python3 tools/capture_all_baselines.py        # Flash + capture from HW
python3 tools/capture_renode_baselines.py     # Capture from Renode
python3 tools/compare_all_baselines.py [-v]   # Diff HW vs Renode
```
